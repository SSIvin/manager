...
<xsl:stylesheet version="2.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template match="/">
        <html>
            ...
            <body>
                <div>
                    ID ЗАПРОСА:
                    <xsl:value-of select="ReportPrint/DOHFLNAResponse/@ИдЗапрос"/>
                </div>
                <xsl:apply-templates select="ReportPrint/DOHFLNAResponse/ДохФЛ"/>
            </body>
        </html>
    </xsl:template>
    ...
    <!--<xsl:template name="ФИО">-->
        <!--<div>-->
            <!--ФИО: <xsl:value-of select="./ФИО/@FamilyName"/> <xsl:value-of select="./ФИО/@FirstName"/> <xsl:if test_xslt="./ФИО/@Patronymic!=''"> <xsl:value-of select="./ФИО/@Patronymic"/>-->
        <!--</xsl:if>-->
    ...
    <!--<xsl:template match="СвНА">-->
        ...
        <!--&lt;!&ndash; <xsl:apply-templates></xsl:apply-templates> &ndash;&gt;-->
    <!--</xsl:template>-->
    ...
    <!--<xsl:template match="СведДох_2НДФЛ">-->
        ...
        <!--&lt;!&ndash;СГДНалПер&ndash;&gt;-->
        <!--<xsl:choose>-->
            <!--<xsl:when test_xslt="СГДНалПер">-->

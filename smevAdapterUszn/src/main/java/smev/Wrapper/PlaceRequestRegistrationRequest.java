...
import smev.ElementServices.Mvd.RegistrationRequest3;
...
@Component
public class PlaceRequestRegistrationRequest extends ObjectMessage implements TypeBussines, CreateMessageStrategy, ReceiveMessageStrategy {

    private RegistrationRequest3 data;
...
//        }
    ...
    public String getIdInquery() {
        return InquiryVersionEnum.getInquiryId(InquiryVersionEnum.MVD_PL_REG).toString();
    }
}

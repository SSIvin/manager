 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="День" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}number-2"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="Месяц" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}number-2"/>
 *         &lt;/choice>
 *         &lt;element name="Год">
 *           &lt;simpleType>
...
@XmlType(name = "ДатаДокТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", propOrder = {
    "прДень",
    "день",
    "прМесяц",
    "месяц",
...
public class ДатаДокТип {
    ...
    @XmlElement(name = "ПрДень", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прДень;
    @XmlElement(name = "День", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected BigInteger день;
    @XmlElement(name = "ПрМесяц", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прМесяц;
    @XmlElement(name = "Месяц", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected BigInteger месяц;
    @XmlElement(name = "Год", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", required = true)

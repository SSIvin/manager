 ...
 *       &lt;attribute name="КодВидДок" use="required" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}СПДУЛТип" />
 *       &lt;attribute name="СерДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1_40" />
 *       &lt;attribute name="НомДок" use="required" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1_40" />
 *       &lt;attribute name="ДатаДок" type="{http://www.w3.org/2001/XMLSchema}date" />
 *       &lt;attribute name="ВыдДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-255" />
 *       &lt;attribute name="КодВыдДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-7" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "УдЛичнФЛСНТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")

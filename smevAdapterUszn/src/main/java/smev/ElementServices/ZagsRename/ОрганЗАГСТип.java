 ...
 *       &lt;attribute name="КодЗАГС" use="required" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-8" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "ОрганЗАГСТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")

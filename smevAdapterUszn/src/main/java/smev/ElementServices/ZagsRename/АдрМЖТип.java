 ...
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                 &lt;choice>
 *                   &lt;element name="АдрРФФИАС" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}АдрРФТип"/>
 *                   &lt;element name="АдрРФНеФИАС" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}АдрРФТип"/>
 *                   &lt;element name="АдрТекст" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-512"/>
 *                 &lt;/choice>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 ...
 *                       &lt;/simpleType>
 *                     &lt;/element>
 *                     &lt;element name="ОКСМ" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}ОКСМТип"/>
 *                   &lt;/choice>
 *                   &lt;element name="АдрТекст" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-512"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 ...
 *           &lt;/complexType>
 *         &lt;/element>
 *         &lt;element name="АдрМЖКонв" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-512"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "АдрМЖТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", propOrder = {
    "адрМЖРФ",
    "адрМЖИн",
    "адрМЖКонв"
})
public class АдрМЖТип {
    ...
    @XmlElement(name = "АдрМЖРФ", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected АдрМЖТип.АдрМЖРФ адрМЖРФ;
    @XmlElement(name = "АдрМЖИн", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected АдрМЖТип.АдрМЖИн адрМЖИн;
    @XmlElement(name = "АдрМЖКонв", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    ...
    public static class АдрМЖИн {
        ...
        @XmlElement(name = "ПрОКСМ", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
        protected String прОКСМ;
        @XmlElement(name = "ОКСМ", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
        protected String оксм;
        @XmlElement(name = "АдрТекст", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", required = true)
    ...
    public static class АдрМЖРФ {
        ...
        @XmlElement(name = "АдрРФФИАС", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
        protected АдрРФТип адрРФФИАС;
        @XmlElement(name = "АдрРФНеФИАС", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
        protected АдрРФТип адрРФНеФИАС;
        @XmlElement(name = "АдрТекст", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
        protected String адрТекст;

 ...
 *       &lt;choice>
 *         &lt;element name="ЗапАктОсн" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}ЗапАктТип"/>
 *         &lt;element name="ДокОсн" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}СведДокТип"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "СведДокОснТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", propOrder = {
    "запАктОсн",
    "докОсн"
})
public class СведДокОснТип {

    @XmlElement(name = "ЗапАктОсн", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected ЗапАктТип запАктОсн;
    @XmlElement(name = "ДокОсн", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")

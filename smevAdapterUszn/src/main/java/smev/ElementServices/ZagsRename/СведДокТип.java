 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="КодДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-5"/>
 *           &lt;element name="НаимДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-500"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="СерНомДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1_40"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="НаимОрг" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1000"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlType(name = "СведДокТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", propOrder = {
    "прДок",
    "кодДок",
    "наимДок",
    "прСерНомДок",
...
public class СведДокТип {
    ...
    @XmlElement(name = "ПрДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прДок;
    @XmlElement(name = "КодДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String кодДок;
    @XmlElement(name = "НаимДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String наимДок;
    @XmlElement(name = "ПрСерНомДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прСерНомДок;
    @XmlElement(name = "СерНомДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    ...
    @XmlElement(name = "ПрНаимОрг", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прНаимОрг;
    @XmlElement(name = "НаимОрг", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")

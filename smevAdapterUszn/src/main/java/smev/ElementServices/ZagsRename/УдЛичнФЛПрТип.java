 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="КодВидДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}СПДУЛТип"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="СерДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1_40"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="НомДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1_40"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *           &lt;element name="ДатаДокНеполн" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}ДатаДокТип"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="ВыдДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-1000"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="КодВыдДок" type="{urn://x-artefacts-zags-pernameinf/types/4.0.0}string-7"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
@XmlType(name = "УдЛичнФЛПрТип", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0", propOrder = {
    "прКодВидДок",
    "кодВидДок",
    "прСерДок",
    "серДок",
...
public class УдЛичнФЛПрТип {
    ...
    @XmlElement(name = "ПрКодВидДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прКодВидДок;
    @XmlElement(name = "КодВидДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String кодВидДок;
    @XmlElement(name = "ПрСерДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прСерДок;
    @XmlElement(name = "СерДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String серДок;
    @XmlElement(name = "ПрНомДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прНомДок;
    @XmlElement(name = "НомДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String номДок;
    @XmlElement(name = "ПрДатаДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прДатаДок;
    @XmlElement(name = "ДатаДокКаленд", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar датаДокКаленд;
    @XmlElement(name = "ДатаДокНеполн", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected ДатаДокТип датаДокНеполн;
    @XmlElement(name = "ПрВыдДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прВыдДок;
    @XmlElement(name = "ВыдДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String выдДок;
    @XmlElement(name = "ПрКодВыдДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")
    protected String прКодВыдДок;
    @XmlElement(name = "КодВыдДок", namespace = "urn://x-artefacts-zags-pernameinf/types/4.0.0")

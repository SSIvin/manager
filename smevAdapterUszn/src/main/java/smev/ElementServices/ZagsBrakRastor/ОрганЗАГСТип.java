 ...
 *       &lt;attribute name="НаимЗАГС" use="required" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-1000" />
 *       &lt;attribute name="КодЗАГС" use="required" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-8" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "ОрганЗАГСТип", namespace = "urn://x-artefacts-zags-brakrastinf/types/4.0.0")
@Data

 ...
 *       &lt;attribute name="КодЗАГС" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-8" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "ОрганЗАГСНТип", namespace = "urn://x-artefacts-zags-brakrastinf/types/4.0.0")
@Data

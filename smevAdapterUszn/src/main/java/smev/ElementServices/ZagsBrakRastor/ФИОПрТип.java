 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="Фамилия" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-60"/>
...
@XmlType(name = "ФИОПрТип", namespace = "urn://x-artefacts-zags-brakrastinf/types/4.0.0", propOrder = {
    "фамилия",
    "прФамилия",
    "имя",
    "прИмя",
...
public class ФИОПрТип {
    ...
    @XmlElement(name = "Фамилия", namespace = "urn://x-artefacts-zags-brakrastinf/types/4.0.0")
    protected String фамилия;
    @XmlElement(name = "ПрФамилия", namespace = "urn://x-artefacts-zags-brakrastinf/types/4.0.0")

...
@XmlRootElement(name = "BRAKRASTINFRequest", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
@Data
public class BRAKRASTINFRequest implements TypeBussines {

    @XmlElement(name = "СведОсн", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0", required = true)
    protected BRAKRASTINFRequest.СведОсн сведОсн;

    @XmlElement(name = "СведЗапрос", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0", required = true)
    protected BRAKRASTINFRequest.СведЗапрос сведЗапрос;
//    protected List<BRAKRASTINFRequest.СведЗапрос> сведЗапрос;
     ...
     *                   &lt;/choice>
     *                   &lt;element name="ОрганЗАГС" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}ОрганЗАГСНТип"/>
     *                 &lt;/sequence>
     ...
     *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
     *                 &lt;sequence>
     *                   &lt;element name="ФИО" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}ФИОПрТип"/>
     *                   &lt;choice>
     ...
     *                     &lt;element name="ДатаРождДок" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}ДатаДокТип"/>
     *                   &lt;/choice>
     *                   &lt;element name="УдЛичнФЛ" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}УдЛичнФСНЛТип" minOccurs="0"/>
     *                 &lt;/sequence>
     ...
     *                   &lt;/simpleType>
     *                 &lt;/attribute>
     *                 &lt;attribute name="СНИЛС" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}СНИЛСТип" />
     *               &lt;/restriction>
     *             &lt;/complexContent>
     *           &lt;/complexType>
     *         &lt;/element>
     ...
     *             &lt;/simpleType>
     *           &lt;/element>
     *           &lt;element name="РегионРегАГС" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}ССРФТип"/>
     *         &lt;/choice>
     *       &lt;/sequence>
    ...
    public static class СведЗапрос {
        ...
        @XmlElement(name = "СведАГС", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
        protected BRAKRASTINFRequest.СведЗапрос.СведАГС сведАГС;
        @XmlElement(name = "СведФЛ", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0", required = true)
        protected BRAKRASTINFRequest.СведЗапрос.СведФЛ сведФЛ;
        @XmlElement(name = "ПрРегионРегАГС", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
        protected String прРегионРегАГС;
        @XmlElement(name = "РегионРегАГС", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
         ...
         * @return
         *     possible object is
         *     {@link BRAKRASTINFRequest.СведЗапрос.СведАГС }
         *
         */
        public BRAKRASTINFRequest.СведЗапрос.СведАГС getСведАГС() {
            return сведАГС;
        }
         ...
         *
         */
        public void setСведАГС(BRAKRASTINFRequest.СведЗапрос.СведАГС value) {
            this.сведАГС = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link BRAKRASTINFRequest.СведЗапрос.СведФЛ }
         *
         */
        public BRAKRASTINFRequest.СведЗапрос.СведФЛ getСведФЛ() {
            return сведФЛ;
        }
         ...
         *
         */
        public void setСведФЛ(BRAKRASTINFRequest.СведЗапрос.СведФЛ value) {
            this.сведФЛ = value;
        }
        ...
        public static class СведФЛ {
            ...
            @XmlElement(name = "ФИО", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0", required = true)
            protected ФИОПрТип фио;

            @XmlElement(name = "ПрДатаРожд", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
            protected String прДатаРожд;

            @XmlElement(name = "ДатаРождКаленд", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
//            @XmlSchemaType(name = "date")
            @XmlJavaTypeAdapter(LocalDateAdapter.class)
            protected LocalDate датаРождКаленд;

            @XmlElement(name = "ДатаРождДок", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
            protected ДатаДокТип датаРождДок;

            @XmlElement(name = "УдЛичнФЛ", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
            protected УдЛичнФСНЛТип удЛичнФЛ;
     ...
     *           &lt;/simpleType>
     *         &lt;/element>
     *         &lt;element name="СведДокОсн" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-500"/>
     *       &lt;/choice>
     *       &lt;attribute name="КодНормОсн" use="required" type="{urn://x-artefacts-zags-brakrastinf/types/4.0.0}string-2" />
     *     &lt;/restriction>
     *   &lt;/complexContent>
     * &lt;/complexType>
     * </pre>
    ...
    public static class СведОсн {
        ...
        @XmlElement(name = "ПрСведДокОсн", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")
        protected String прСведДокОсн;
        @XmlElement(name = "СведДокОсн", namespace = "urn://x-artefacts-zags-brakrastinf/root/112-55/4.0.0")

 ...
 * ������������ ��������������
 *
 * <p>Java class for TPowerOfAttorneyRestr complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TPowerOfAttorneyRestr">
 *   &lt;complexContent>
...
@XmlType(name = "TPowerOfAttorneyRestr", namespace = "http://rosreestr.ru/services/v0.1/commons/Documents")
public class TPowerOfAttorneyRestr

 ...
 * ���. ����/������� ����/��� ������������/�����-���� ��������������
 *
 * <p>Java class for TMapPlanDocumentRestr complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TMapPlanDocumentRestr">
 *   &lt;complexContent>
...
@XmlType(name = "TMapPlanDocumentRestr", namespace = "http://rosreestr.ru/services/v0.1/commons/Documents")
public class TMapPlanDocumentRestr
    extends TLegalAct
{

 ...
 * �������� ��������� �� ����� 2, ������� ����� ���������� � ������ ���������
 *
 * <p>Java class for TPreviligedPersonForm2 complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TPreviligedPersonForm2">
 *   &lt;complexContent>
...
@XmlType(name = "TPreviligedPersonForm2", namespace = "http://rosreestr.ru/services/v0.1/commons/Subjects")
public class TPreviligedPersonForm2

 ...
 * ������� ��������� ������� ����� ���������� � ������ ���������
 *
 * <p>Java class for TPreviligedPerson complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TPreviligedPerson">
 *   &lt;complexContent>
...
@XmlType(name = "TPreviligedPerson", namespace = "http://rosreestr.ru/services/v0.1/commons/Subjects")
public class TPreviligedPerson

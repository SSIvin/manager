 ...
 * ��������, ������� ����� ��������� �������� ����������� ����������, ����� � ��. ���������� �������� ���������.
 *
 * <p>Java class for TStrictDocument complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TStrictDocument">
 *   &lt;complexContent>
...
@XmlType(name = "TStrictDocument", namespace = "http://rosreestr.ru/services/v0.1/commons/Documents")
@XmlSeeAlso({
    TPowerOfAttorneyRestr.class,
    TPaymentDocument.class,
    TDocumentSeries.class,
    TOtherDocumentRestr.class,
    TConfirmPrivilege.class,
    TDocumentWithNumber.class
})
public class TStrictDocument

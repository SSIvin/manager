...
@XmlType(name = "Trequest2", namespace = "http://rosreestr.ru/services/v0.12/TRequest", propOrder = {
        "region",
        "externalNumber",
        "senderType",
        "actionCode",
...
@XmlRootElement(name = "request", namespace = "http://rosreestr.ru/services/v0.12/TRequest")
@Data
public class Trequest2 implements TypeBussines {

 ...
 * ��� ����� ��������� ��� ���������� (�������)
 *
 * <p>Java class for TValidatedStructuredAttachmentFormat complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TValidatedStructuredAttachmentFormat">
 *   &lt;complexContent>
...
@XmlType(name = "TValidatedStructuredAttachmentFormat", propOrder = {
    "isUnstructuredFormat",
    "isZippedPacket",
    "fileName"
})
public class TValidatedStructuredAttachmentFormat {

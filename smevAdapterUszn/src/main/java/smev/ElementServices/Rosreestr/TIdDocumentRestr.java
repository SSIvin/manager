 ...
 * �������� �������������� �������� ��������������
 *
 * <p>Java class for TIdDocumentRestr complex type.
 *
 * <p>The following schema fragment specifies the expected content contained within this class.
 *
 * <pre>
 * &lt;complexType name="TIdDocumentRestr">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://rosreestr.ru/services/v0.1/commons/Documents}TDocumentWithNumber">
 *       &lt;sequence>
...
@XmlType(name = "TIdDocumentRestr", namespace = "http://rosreestr.ru/services/v0.1/commons/Documents")
public class TIdDocumentRestr

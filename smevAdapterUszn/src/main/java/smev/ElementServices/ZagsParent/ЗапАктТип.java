...
@XmlType(name = "ЗапАктТип", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0", propOrder = {
    "прДатаЗапис",
    "датаЗапис",
    "датаЗаписДок",
    "органЗАГС"
...
public class ЗапАктТип {
    ...
    @XmlElement(name = "ПрДатаЗапис", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прДатаЗапис;
    @XmlElement(name = "ДатаЗапис", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar датаЗапис;
    @XmlElement(name = "ДатаЗаписДок", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")

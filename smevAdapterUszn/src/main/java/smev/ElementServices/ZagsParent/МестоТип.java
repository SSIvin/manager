 ...
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *       &lt;attribute name="МестоТекст" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-512" />
 *       &lt;attribute name="КодСтраны" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ОКСМТип" />
 *       &lt;attribute name="НаимСтраны" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-255" />
 *       &lt;attribute name="Регион" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ССРФТип" />
 *       &lt;attribute name="НаимСубъект" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
...
@XmlType(name = "МестоТип", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")

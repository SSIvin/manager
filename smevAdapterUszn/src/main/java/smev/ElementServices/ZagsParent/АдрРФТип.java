 ...
 *       &lt;attribute name="АдрТекст" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-512" />
 *       &lt;attribute name="ИдНом" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-36" />
 *       &lt;attribute name="ОКТМО" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ОКТМОТипН" />
 *       &lt;attribute name="Индекс" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}digits-6" />
 *       &lt;attribute name="КодРегион" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ССРФТип" />
 *       &lt;attribute name="НаимРегион" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
 *       &lt;attribute name="Район" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
 *       &lt;attribute name="Город" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
 *       &lt;attribute name="НаселПункт" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
 *       &lt;attribute name="Улица" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-50" />
 *       &lt;attribute name="Дом" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-20" />
 *       &lt;attribute name="Корпус" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-20" />
 *       &lt;attribute name="Кварт" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-20" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "АдрРФТип", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")

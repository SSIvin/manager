...
@XmlRootElement(name = "PARENTINFRequest", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
@Data
public class PARENTINFRequest implements TypeBussines {

    @XmlElement(name = "СведОсн", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0", required = true)
    protected PARENTINFRequest.СведОсн сведОсн;

    @XmlElement(name = "СведЗапрос", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0", required = true)
    protected PARENTINFRequest.СведЗапрос сведЗапрос;
//    protected List<PARENTINFRequest.СведЗапрос> сведЗапрос;
     ...
     *                   &lt;/choice>
     *                   &lt;element name="ОрганЗАГС" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ОрганЗАГСНТип"/>
     *                 &lt;/sequence>
     *                 &lt;attribute name="НомерЗапис" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-22" />
     *               &lt;/restriction>
     *             &lt;/complexContent>
     *           &lt;/complexType>
     *         &lt;/element>
     ...
     *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
     *                 &lt;sequence>
     *                   &lt;element name="ФИО" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ФИОПрТип"/>
     *                   &lt;choice>
     ...
     *                   &lt;/choice>
     *                   &lt;element name="УдЛичнФЛ" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}УдЛичнФЛСНТип" minOccurs="0"/>
     *                 &lt;/sequence>
     ...
     *             &lt;/simpleType>
     *           &lt;/element>
     *           &lt;element name="РегионРегАГС" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ССРФТип"/>
     *         &lt;/choice>
     *       &lt;/sequence>
    ...
    public static class СведЗапрос {
        ...
        @XmlElement(name = "СведАГС", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
        protected PARENTINFRequest.СведЗапрос.СведАГС сведАГС;
        @XmlElement(name = "СведФЛ", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0", required = true)
        protected PARENTINFRequest.СведЗапрос.СведФЛ сведФЛ;
        @XmlElement(name = "ПрРегионРегАГС", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
        protected String прРегионРегАГС;
        @XmlElement(name = "РегионРегАГС", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
         ...
         * @return
         *     possible object is
         *     {@link PARENTINFRequest.СведЗапрос.СведАГС }
         *
         */
        public PARENTINFRequest.СведЗапрос.СведАГС getСведАГС() {
            return сведАГС;
        }
         ...
         *
         */
        public void setСведАГС(PARENTINFRequest.СведЗапрос.СведАГС value) {
            this.сведАГС = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link PARENTINFRequest.СведЗапрос.СведФЛ }
         *
         */
        public PARENTINFRequest.СведЗапрос.СведФЛ getСведФЛ() {
            return сведФЛ;
        }
         ...
         *
         */
        public void setСведФЛ(PARENTINFRequest.СведЗапрос.СведФЛ value) {
            this.сведФЛ = value;
        }
        ...
        public static class СведФЛ {
            ...
            @XmlElement(name = "ФИО", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0", required = true)
            ...
            @XmlElement(name = "УдЛичнФЛ", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
     ...
     *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
     *       &lt;choice>
     *         &lt;element name="СведДокОсн" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-500"/>
     ...
     *         &lt;/element>
     *       &lt;/choice>
     *       &lt;attribute name="КодНормОсн" use="required" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-2" />
     *     &lt;/restriction>
     *   &lt;/complexContent>
     * &lt;/complexType>
     * </pre>
    ...
    public static class СведОсн {
        ...
        @XmlElement(name = "СведДокОсн", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")
        protected String сведДокОсн;
        @XmlElement(name = "ПрСведДокОсн", namespace = "urn://x-artefacts-zags-parentinf/root/112-56/4.0.0")

 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="ГраждТекст" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}string-255"/>
 *           &lt;element name="ГраждОКСМ" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}ОКСМТип"/>
 *         &lt;/choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="УдЛичнФЛ" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}УдЛичнФЛПрТип"/>
 *         &lt;/choice>
 *         &lt;choice>
 ...
 *             &lt;/simpleType>
 *           &lt;/element>
 *           &lt;element name="АдрМЖ" type="{urn://x-artefacts-zags-parentinf/types/4.0.0}АдрМЖТип"/>
 *         &lt;/choice>
 *       &lt;/sequence>
...
@XmlType(name = "СведРодитТип", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0", propOrder = {
    "прГражданство",
    "граждТекст",
    "граждОКСМ",
    "фио",
...
public class СведРодитТип {
    ...
    @XmlElement(name = "ПрГражданство", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прГражданство;
    @XmlElement(name = "ГраждТекст", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String граждТекст;
    @XmlElement(name = "ГраждОКСМ", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String граждОКСМ;
    @XmlElement(name = "ФИО", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0", required = true)
    protected ФИОПрТип фио;
    @XmlElement(name = "ПрМестоРожден", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прМестоРожден;
    @XmlElement(name = "МестоРожден", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected МестоТип местоРожден;
    @XmlElement(name = "ПрДатаРожд", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прДатаРожд;
    @XmlElement(name = "ДатаРождКаленд", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar датаРождКаленд;
    @XmlElement(name = "ДатаРождДок", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected ДатаДокТип датаРождДок;
    @XmlElement(name = "ПрУдЛичнФЛ", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прУдЛичнФЛ;
    @XmlElement(name = "УдЛичнФЛ", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected УдЛичнФЛПрТип удЛичнФЛ;
    @XmlElement(name = "ПрАдрМЖ", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")
    protected String прАдрМЖ;
    @XmlElement(name = "АдрМЖ", namespace = "urn://x-artefacts-zags-parentinf/types/4.0.0")

 ...
 *       &lt;attribute name="РегНомРеестрНотар" use="required" type="{urn://x-artefacts-zags-brakzakinf/types/4.0.0}string-100" />
 *       &lt;attribute name="ДатаНотарДейств" use="required" type="{http://www.w3.org/2001/XMLSchema}date" />
 *       &lt;attribute name="ФИОНотар" use="required" type="{urn://x-artefacts-zags-brakzakinf/types/4.0.0}string-100" />
 *       &lt;attribute name="ФИОПеревод" type="{urn://x-artefacts-zags-brakzakinf/types/4.0.0}string-1_200" />
...
@XmlType(name = "ЗасвидТип", namespace = "urn://x-artefacts-zags-brakzakinf/types/4.0.0")
@Data

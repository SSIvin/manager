 ...
 *       &lt;/sequence>
 *       &lt;attribute name="ТипАГС" use="required" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-2" />
...
@XmlType(name = "ЗапАктТип", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1", propOrder = {
    "прДатаЗапис",
    "датаЗаписДок",
    "датаЗапис",
    "органЗАГС"
...
public class ЗапАктТип {
    ...
    @XmlElement(name = "ПрДатаЗапис", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String прДатаЗапис;
    @XmlElement(name = "ДатаЗаписДок", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected ДатаДокТип датаЗаписДок;
    @XmlElement(name = "ДатаЗапис", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")

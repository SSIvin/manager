 ...
 *       &lt;choice>
 *         &lt;element name="ЗапАктОсн" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}ЗапАктТип"/>
 *         &lt;element name="ДокОсн" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}СведДокТип"/>
 *       &lt;/choice>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "СведДокОснТип", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1", propOrder = {
    "запАктОсн",
    "докОсн"
})
public class СведДокОснТип {

    @XmlElement(name = "ЗапАктОсн", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected ЗапАктТип запАктОсн;
    @XmlElement(name = "ДокОсн", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")

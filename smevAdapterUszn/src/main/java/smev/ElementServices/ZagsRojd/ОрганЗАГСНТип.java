 ...
 *       &lt;attribute name="КодЗАГС" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-8" />
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
 * </pre>
...
@XmlType(name = "ОрганЗАГСНТип", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")

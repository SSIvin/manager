 ...
 *       &lt;sequence>
 *         &lt;choice>
 *           &lt;element name="Фамилия" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-60"/>
 ...
 *         &lt;/choice>
 *         &lt;choice>
 *           &lt;element name="Имя" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-60"/>
 *           &lt;element name="ПрИмя">
 *             &lt;simpleType>
 *               &lt;restriction base="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-1">
 *                 &lt;enumeration value="1"/>
 ...
 *         &lt;/choice>
 *         &lt;choice>
 *           &lt;element name="Отчество" type="{urn://x-artefacts-zags-rogdinf/types/4.0.1}string-60"/>
...
@XmlType(name = "ФИОПрТип", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1", propOrder = {
    "фамилия",
    "прФамилия",
    "имя",
    "прИмя",
...
public class ФИОПрТип {
    ...
    @XmlElement(name = "Фамилия", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String фамилия;
    @XmlElement(name = "ПрФамилия", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String прФамилия;
    @XmlElement(name = "Имя", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String имя;
    @XmlElement(name = "ПрИмя", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String прИмя;
    @XmlElement(name = "Отчество", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")
    protected String отчество;
    @XmlElement(name = "ПрОтчество", namespace = "urn://x-artefacts-zags-rogdinf/types/4.0.1")

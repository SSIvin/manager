...
@Data
@XmlRootElement(name = "livingPlaceRegistrationRequest"
        , namespace = "urn://mvd/guvm/living-place-registration/1.1.0"
)
public class RegistrationRequest2 extends RegistrationRequest implements TypeBussines{

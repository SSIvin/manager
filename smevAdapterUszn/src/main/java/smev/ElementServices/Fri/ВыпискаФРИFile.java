...
public class ВыпискаФРИFile {
    ...
    protected ВыпискаФРИFile.ПерсональныеДанные персональныеДанные;
    @XmlElement(name = "ВсеФайлы", namespace = "http://fri.pfr.ru", required = true)
    protected ВыпискаФРИFile.ВсеФайлы всеФайлы;
     ...
     * @return
     *     possible object is
     *     {@link ВыпискаФРИFile.ПерсональныеДанные }
     *
     */
    public ВыпискаФРИFile.ПерсональныеДанные getПерсональныеДанные() {
     ...
     *
     */
    public void setПерсональныеДанные(ВыпискаФРИFile.ПерсональныеДанные value) {
     ...
     *
     */
    public ВсеФайлы getВсеДокументы() {
        return всеФайлы;
    }
     ...
     *
     */
    public void setВсеДокументы(ВсеФайлы value) {
        this.всеФайлы = value;
    }
    ...
    public static class ВсеФайлы {

        @XmlElement(name = "Файл", namespace = "http://fri.pfr.ru")
        protected List<Файл> файл;
         ...
         *
         */
        public List<Файл> getФайл() {
            if (файл == null) {
                файл = new ArrayList<Файл>();
            }
            return this.файл;
        }
        ...
        public static class Файл {
            ...
            @XmlElement(name = "РеквизитыФайла", namespace = "http://fri.pfr.ru", required = true)
            protected РеквизитыФайла реквизитыФайла;
            @XmlElement(name = "ВсеСведения", namespace = "http://fri.pfr.ru", required = true)
            protected Файл.ВсеСведения всеСведения;
             ...
             *
             */
            public РеквизитыФайла getРеквизитыДокумента() {
                return реквизитыФайла;
            }
             ...
             *
             */
            public void setРеквизитыДокумента(РеквизитыФайла value) {
                this.реквизитыФайла = value;
            }
             ...
             * @return
             *     possible object is
             *     {@link Файл.ВсеСведения }
             *
             */
            public Файл.ВсеСведения getВсеСведения() {
                return всеСведения;
            }
             ...
             *
             */
            public void setВсеСведения(Файл.ВсеСведения value) {
            ...
            public static class ВсеСведения {
                ...
                public static class Запись {
                    ...
                    protected Файл.ВсеСведения.Запись.Категория категория;
                    @XmlElement(name = "ВсеАтрибуты", namespace = "http://fri.pfr.ru", required = true)
                    protected Файл.ВсеСведения.Запись.ВсеАтрибуты всеАтрибуты;
                     ...
                     * @return
                     *     possible object is
                     *     {@link Файл.ВсеСведения.Запись.Категория }
                     *
                     */
                    public Файл.ВсеСведения.Запись.Категория getКатегория() {
                        return категория;
                    }
                     ...
                     *
                     */
                    public void setКатегория(Файл.ВсеСведения.Запись.Категория value) {
                     ...
                     * @return
                     *     possible object is
                     *     {@link Файл.ВсеСведения.Запись.ВсеАтрибуты }
                     *
                     */
                    public Файл.ВсеСведения.Запись.ВсеАтрибуты getВсеАтрибуты() {
                        return всеАтрибуты;
                    }
                     ...
                     *
                     */
                    public void setВсеАтрибуты(Файл.ВсеСведения.Запись.ВсеАтрибуты value) {
                    ...
                    public static class ВсеАтрибуты {
                         ...
                         * <p>
                         * Objects of the following type(s) are allowed in the list
                         * {@link Файл.ВсеСведения.Запись.ВсеАтрибуты.Атрибут }
                         *
                         *
                         */
            ...
            public static class РеквизитыФайла {
                ...
                protected РеквизитыФайла.Источник источник;
                ...
                protected РеквизитыФайла.ТипДокумента типДокумента;
                 ...
                 * @return
                 *     possible object is
                 *     {@link РеквизитыФайла.Источник }
                 *
                 */
                public РеквизитыФайла.Источник getИсточник() {
                    return источник;
                }
                 ...
                 *
                 */
                public void setИсточник(РеквизитыФайла.Источник value) {
                    this.источник = value;
                }
                 ...
                 * @return
                 *     possible object is
                 *     {@link РеквизитыФайла.ТипДокумента }
                 *
                 */
                public РеквизитыФайла.ТипДокумента getТипДокумента() {
                    return типДокумента;
                }
                 ...
                 *
                 */
                public void setТипДокумента(РеквизитыФайла.ТипДокумента value) {
    ...
    public static class ПерсональныеДанные {
        ...
        protected ВыпискаФРИFile.ПерсональныеДанные.АктуальныеСведенияОбИнвалидности актуальныеСведенияОбИнвалидности;
         ...
         * @return
         *     possible object is
         *     {@link ВыпискаФРИFile.ПерсональныеДанные.АктуальныеСведенияОбИнвалидности }
         *
         */
        public ВыпискаФРИFile.ПерсональныеДанные.АктуальныеСведенияОбИнвалидности getАктуальныеСведенияОбИнвалидности() {
         ...
         *
         */
        public void setАктуальныеСведенияОбИнвалидности(ВыпискаФРИFile.ПерсональныеДанные.АктуальныеСведенияОбИнвалидности value) {

...
@XmlRootElement(name = "FATALINFRequest", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")
@Data
public class FATALINFRequest implements TypeBussines {

    @XmlElement(name = "СведОсн", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1", required = true)
    protected FATALINFRequest.СведОсн сведОсн;

    @XmlElement(name = "СведЗапрос", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1", required = true)
    protected FATALINFRequest.СведЗапрос сведЗапрос;
//    protected List<FATALINFRequest.СведЗапрос> сведЗапрос;
    ...
    public static class СведЗапрос {
        ...
        @XmlElement(name = "СведАГС", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")
        protected FATALINFRequest.СведЗапрос.СведАГС сведАГС;

        @XmlElement(name = "СведФЛ", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1", required = true)
        protected FATALINFRequest.СведЗапрос.СведФЛ сведФЛ;

        @XmlElement(name = "ПрРегионРегАГС", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")
        protected String прРегионРегАГС;

        @XmlElement(name = "РегионРегАГС", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")
        ...
        public static class СведФЛ {
            ...
            @XmlElement(name = "ФИО", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1", required = true)
    ...
    public static class СведОсн {
        ...
        @XmlElement(name = "СведДокОсн", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")
        protected String сведДокОсн;
        @XmlElement(name = "ПрСведДокОсн", namespace = "urn://x-artefacts-zags-fatalinf/root/112-52/4.0.1")

...
@XmlType(name = "АдрМЖТип", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1", propOrder = {
    "адрМЖРФ",
    "адрМЖИн",
    "адрМЖКонв"
})
public class АдрМЖТип {
    ...
    @XmlElement(name = "АдрМЖРФ", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected АдрМЖТип.АдрМЖРФ адрМЖРФ;
    @XmlElement(name = "АдрМЖИн", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected АдрМЖТип.АдрМЖИн адрМЖИн;
    @XmlElement(name = "АдрМЖКонв", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    ...
    public static class АдрМЖИн {
        ...
        @XmlElement(name = "ПрОКСМ", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
        protected String прОКСМ;
        @XmlElement(name = "ОКСМ", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
        protected String оксм;
        @XmlElement(name = "АдрТекст", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1", required = true)
    ...
    public static class АдрМЖРФ {
        ...
        @XmlElement(name = "АдрРФФИАС", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
        protected АдрРФТип адрРФФИАС;
        @XmlElement(name = "АдрРФНеФИАС", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
        protected АдрРФТип адрРФНеФИАС;
        @XmlElement(name = "АдрТекст", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
        protected String адрТекст;

...
@XmlType(name = "ДатаДокТип", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1", propOrder = {
    "прДень",
    "день",
    "прМесяц",
    "месяц",
...
public class ДатаДокТип {
    ...
    @XmlElement(name = "ПрДень", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String прДень;
    @XmlElement(name = "День", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected BigInteger день;
    @XmlElement(name = "ПрМесяц", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String прМесяц;
    @XmlElement(name = "Месяц", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected BigInteger месяц;
    @XmlElement(name = "Год", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1", required = true)

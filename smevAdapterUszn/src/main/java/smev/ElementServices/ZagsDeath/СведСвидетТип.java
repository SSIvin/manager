...
@XmlType(name = "СведСвидетТип", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1", propOrder = {
    "прСерияСвидет",
    "серияСвидет",
    "прНомерСвидет",
    "номерСвидет",
...
public class СведСвидетТип {
    ...
    @XmlElement(name = "ПрСерияСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String прСерияСвидет;
    @XmlElement(name = "СерияСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String серияСвидет;
    @XmlElement(name = "ПрНомерСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String прНомерСвидет;
    @XmlElement(name = "НомерСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String номерСвидет;
    @XmlElement(name = "ПрДатаВыдСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    protected String прДатаВыдСвидет;
    @XmlElement(name = "ДатаВыдСвидет", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar датаВыдСвидет;
    @XmlElement(name = "ДатаВыдСвидетДок", namespace = "urn://x-artefacts-zags-fatalinf/types/4.0.1")
